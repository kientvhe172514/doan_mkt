...
const AddProduct = () => {
  const [product, setProduct] = useState({
    ...
    discount: 0,
    quantity: 0,
    brand: { name: "Deepcool", id: "64154ee693b3f0f2c7ec7ff8" },
        ...
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            <Row>
              ...
              {/* Right Column */}
              <Col md={6}>
                <h4 className="border-bottom pb-2 mb-3">Chi tiết & Ảnh</h4>
                          ...
                          <InputGroup>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                tempImg.onerror = () => {
                                  alert(
                                    "Invalid image URL. Please check the link."
                                  );
                                };
