            ...
            <div className="col-xl-8 col-lg-8 col-md-10">
              <div className="tp-postbox-details-main-wrapper tp-postbox-style2">
                ...
                <h4 className="tp-postbox-details-heading">Câu Chuyện Thương Hiệu</h4>
                  ...
                  <p>LMuse là thương hiệu thời trang thiết kế dành riêng cho phụ nữ ngoại cỡ - những người luôn muốn mặc đẹp không phải để che giấu, mà để bộc lộ bản thân một cách tự tin và đầy kiêu hãnh.

Chúng tôi sinh ra từ một câu hỏi giản đơn nhưng đầy trăn trở: Tại sao phụ nữ big-size lại không có những lựa chọn thời trang xứng đáng như bất kỳ ai? Từ đó, LMuse ra đời như một lời hồi đáp mạnh mẽ - rằng cái đẹp không bị giới hạn bởi số đo, và mọi vóc dáng đều xứng đáng được tôn vinh bằng những thiết kế chỉn chu, thời thượng và đầy cảm xúc.

Tại LMuse, mỗi sản phẩm là sự kết hợp giữa kỹ thuật cắt may chuẩn chỉnh cho vóc dáng đầy đặn, chất liệu cao cấp và tinh thần thiết kế hiện đại. Không chỉ là quần áo - đó là cách bạn thể hiện bản lĩnh, cá tính và tình yêu với chính mình.
...
LMuse không chỉ là thương hiệu! - Đó là phong cách sống, là tiếng nói của một thế hệ phụ nữ dám yêu bản thân - đúng với dáng hình mình đang có.</p>

                  <h4 className="tp-postbox-details-heading">Tầm Nhìn</h4>
                  <p>LMuse hướng tới trở thành thương hiệu thời trang plus-size hàng đầu Việt Nam, là biểu tượng của sự tự tin và vẻ đẹp đa dạng dành cho phụ nữ đầy đặn, góp phần thay đổi cách nhìn nhận của xã hội về vẻ đẹp cơ thể. Trong 5–10 năm tới, LMuse mong muốn mở rộng tầm ảnh hưởng ra thị trường Đông Nam Á, mang phong cách thời trang tinh tế, phù hợp và bền vững đến nhiều người hơn nữa.</p>
                  ...
                  <strong className=''>LMuse hoạt động dựa trên ba giá trị cốt lõi làm nền tảng cho mọi hành động, quyết định và sự phát triển của chúng tôi. Những giá trị này định hướng cam kết của chúng tôi đối với sự xuất sắc và nuôi dưỡng một văn hóa đề cao sự tin cậy, đổi mới và lấy khách hàng làm trọng tâm:</strong>
